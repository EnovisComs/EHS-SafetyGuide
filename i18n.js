...
const translations = {
    ...
    es: {
        ...
        "nav.international": "Visitas Internacionales",
        ...
        "international.title": "Visitantes Internacionales",
        "international.subtitle": "Requisitos de ingreso a las instalaciones de Enovis México",
        "international.who.label": "¿A quién aplica?",
        "international.who.tag1": "Empleados de Enovis de otros sitios en EE.UU.",
        "international.who.tag2": "Empleados de sitios internacionales de Enovis",
        "international.who.tag3": "Consultores externos contratados por Enovis",
        "international.who.tag4": "Visitantes con contacto designado en México",
        "international.highlight": "Para ingresar a las instalaciones de Enovis México, todo visitante internacional deberá contar previamente con la documentación completa requerida tanto para el ingreso al territorio mexicano como para el acceso a la planta.",
        "international.steps.label": "Pasos a seguir",
        "international.steps.step1.title": "Identifica a tu contacto",
        "international.steps.step1.desc": "Localiza a tu contacto asignado dentro de Enovis México antes de planificar tu visita.",
        "international.steps.step2.title": "Solicita la guía completa",
        "international.steps.step2.desc": "Pide a tu contacto de Enovis México la guía de visitantes internacionales, la cual detalla todos los requisitos y pasos a seguir.",
        "international.steps.step3.title": "Reúne la documentación",
        "international.steps.step3.desc": "Tramita y organiza con anticipación todos los documentos requeridos para el ingreso al país y a las instalaciones.",
        "international.steps.step4.title": "Confirma tu visita",
        "international.steps.step4.desc": "Notifica tu llegada con suficiente anticipación para coordinar el acceso y los permisos correspondientes.",
    ...
    en: {
        ...
        "nav.international": "International Visitors",
        "nav.contact": "Contact",
        ...
        "international.title": "International Visitors",
        "international.subtitle": "Entry requirements for Enovis Mexico facilities.",
        "international.who.label": "Who does this apply to?",
        "international.who.tag1": "Enovis employees from U.S.-based sites",
        "international.who.tag2": "Enovis employees from international locations",
        "international.who.tag3": "External consultants engaged by Enovis",
        "international.who.tag4": "Visitors with a designated sponsor in Mexico",
        "international.highlight": "All international visitors must obtain the required documentation prior to their visit — both for entry into Mexican territory and for access to the Enovis Mexico facility. Failure to present complete documentation may result in denied entry.",
        "international.steps.label": "Steps to follow",
        "international.steps.step1.title": "Identify your contact",
        "international.steps.step1.desc": "Reach out to your designated sponsor or Enovis Mexico contact before scheduling your visit.",
        "international.steps.step2.title": "Request the full visitor guide",
        "international.steps.step2.desc": "Ask your sponsor or Enovis Mexico contact to share the International Visitor Guide, which outlines all required steps and documentation.",
        "international.steps.step3.title": "Gather your documents",
        "international.steps.step3.desc": "Prepare and obtain all required documents for entry into Mexico and access to the facility well in advance of your travel date.",
        "international.steps.step4.title": "Confirm your visit",
        "international.steps.step4.desc": "Notify your contact with sufficient lead time to coordinate site access and any required approvals.",
